...
func getAllQuests() []Quest {
	return []Quest{
		...
		{Episode: 1, Name: "Anomalous Ordeal #1", Start: register(82), End: register(254)},
		{Episode: 1, Name: "Anomalous Ordeal #2", Start: register(82), End: register(254)},
		// Today's Rate
		...
		{Episode: 2, Name: "Penumbral Surge #1", Start: register(50), End: register(254), ForceTerminal: true},
		{Episode: 2, Name: "Penumbral Surge #2", Start: register(15), End: register(254), ForceTerminal: true},
		{Episode: 2, Name: "Penumbral Surge #3", Start: register(90), End: register(254), ForceTerminal: true},
		{Episode: 2, Name: "Penumbral Surge #4", Start: register(51), End: register(254), ForceTerminal: true},
		{Episode: 2, Name: "Penumbral Surge #5", Start: register(15), End: register(254), ForceTerminal: true},
		{Episode: 2, Name: "Penumbral Surge #6", Start: register(15), End: register(254), ForceTerminal: true},
